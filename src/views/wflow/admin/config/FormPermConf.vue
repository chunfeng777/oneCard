...
import nodeMixin from "../../design/process/NodeMixin.ts";
import { getFormPermFields } from "../../design/FormInterface.ts";
...
<template>
  <el-table
    ...
    style="width: 100%"
  >
    <template #empty> 未解析到表单字段清单😥 </template>
    <el-table-column prop="title" show-overflow-tooltip label="表单字段">
      <template v-slot="scope">
        <span
          v-if="scope.row.props?.required"
