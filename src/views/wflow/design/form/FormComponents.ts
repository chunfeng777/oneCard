...
// 动态导入组件和配置
const Components = import.meta.glob("./component/*.vue") as Record<
  string,
  () => Promise<DefineComponent<{}, {}, any>>
>;
const ComponentConfigs = import.meta.glob("./config/*.vue") as Record<
  string,
  () => Promise<DefineComponent<{}, {}, any>>
>;

// 批量导出所有 component 目录下的表单组件
...
// 批量导出所有 config 目录下的组件配置
export const FormComponentConfigs: Record<
  string,
  ReturnType<typeof defineAsyncComponent>
> = {};
