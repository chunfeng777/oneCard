...
import { CompareOptions } from "@/utils/ConditionCompare.ts";
...
<template>
  <div>
    ...
    <template v-else-if="type === 'dept'"> </template>
    ...
    <template v-else-if="type === 'array'"> </template>
    <template v-else-if="type === 'date'"> </template>
    <template v-else-if="type === 'dateRange'"> </template>
    <w-org-picker
      :type="pickerType"
      multiple
      ref="orgPicker"
