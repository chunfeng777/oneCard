            ...
            <el-table-column :label="$t('user.operate')" fixed="right">
              <template #default="scope">
                <el-button
                  ...
                  ><i-ep-documentCopy />工单详情</el-button
                >
                <el-button
                  type="success"
                  link
    ...
    >
      ...
      >
        ...
        <el-form-item label="请求人" prop="requesterName">
          <!-- <el-input v-model="formUpdate.requesterId" type="number"></el-input> -->
          <el-select
            disabled
        ...
        <el-form-item label="类型" prop="type">
          <!-- <el-input v-model="formUpdate.type" type="number"></el-input> -->
          <Dict v-model="formUpdate.type" code="ticketsType" />
        </el-form-item>
        <el-form-item label="处理人" prop="handlerName">
          <!-- <el-input v-model="formUpdate.handlerId" type="number"></el-input> -->
          <el-select
            disabled
        ...
        <!-- <el-form-item label="解决方案" prop="resolution">
          <el-input v-model="formUpdate.resolution"></el-input>
        </el-form-item> -->
        <el-form-item label="状态" prop="status">
          <!-- <el-input v-model="formUpdate.status" readonly></el-input> -->
          <Dict v-model="formUpdate.status" code="ticketsStatus" />
        </el-form-item>
        <el-form-item label="优先级" prop="priority">
          <!-- <el-input v-model="formUpdate.priority"></el-input> -->
...
import { AssignReq, UpdateReq } from "@/api/tickets/model";
...
/** 切换类型 */
// async function subProcessing() {
//   loading.value = true;
//   ticketBtn.processing = true;
//   ticketBtn.create = false;
//   ticketBtn.all = false;
//   TicketAPI.getDispose(queryParams)
//     .then((res) => {
//       console.log(res);
...
async function subCreate() {
  loading.value = true;
  // ticketBtn.processing = false;
  // ticketBtn.create = true;
  // ticketBtn.all = false;
  TicketAPI.getLaunch(queryParams)
    .then((res) => {
      // console.log(res);
      pageData.value = res.list;
      tot.value = res.total;
...
const submitForm = () => {
  formRef.value.validate(async (valid: boolean) => {
    if (valid) {
      ...
      // 设置更新时间为格式化后的时间
      // formUpdate.value.updateTime = formattedTime;
      // 显示验证码组件
      isShow.value = true;
      // 调用验证码成功的回调
      onSuccess = async () => {
